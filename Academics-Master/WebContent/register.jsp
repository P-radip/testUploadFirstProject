			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-3 text-right">
						<a href="login.jsp" class="small mr-3"><span
							class="icon-unlock-alt"></span> Log In</a> <a href="register.jsp"
					...
					<div class="mr-auto">
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li><a href="index.jsp" class="nav-link text-left">Home</a>
								</li>
								<li class="has-children"><a href="about.jsp"
									class="nav-link text-left">About Us</a>
									<ul class="dropdown">
										<li><a href="teachers.jsp">Our Teachers</a></li>
										<li><a href="about.jsp">Our School</a></li>
									</ul></li>
								<li><a href="admissions.jsp" class="nav-link text-left">Admissions</a>
								</li>
								<li><a href="courses.jsp" class="nav-link text-left">Courses</a>
								</li>
								<li><a href="contact.jsp" class="nav-link text-left">Contact</a>
								</li>
							</ul>
							</ul>
						</nav>
		...
		<div class="site-section">
			<div class="container">
				...
				<div class="row justify-content-center">
							...
							<div class="row">
								...
								<div class="col-md-12 form-group">
									<label for="email">Email</label> <input type="email"
										name="Uemail" id="email" class="form-control form-control-lg">
								</div>
								<div class="col-md-12 form-group">
									<label for="tel">Tel. Number</label> <input type="text"
										name="number" id="tel" class="form-control form-control-lg">
								</div>
								<div class="col-md-12 form-group">
								...
								<div class="col-md-12 form-group">
									<label for="pword2">Re-type Password</label> <input
										type="password" id="pword2"
										class="form-control form-control-lg">
								</div>
							</div>
							<div class="row">
					...
					<div class="row">
						<div class="col-12">
						<a href="./Controller?choice=2" class="btn btn-primary btn-lg px-5">Show Data</a>
